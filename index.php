							...
							<li class="mb-4 mb-lg-2">
								<span class="d-flex align-items-center justify-content-end justify-content-lg-end flex-column flex-lg-row font-weight-medium text-4 text-lg-3 text-xl-4">
									...
									<strong class="text-7 mt-2 mt-lg-0 ms-lg-3">
										<a href="tel:<?= $phone ?>" class="text-color-secondary text-color-hover-primary text-decoration-none"><?= $phone ?></a>
									</strong>
								</span>
							</li>
							<li class="mb-0">
								<span class="d-flex align-items-center justify-content-end justify-content-lg-end flex-column flex-lg-row font-weight-medium text-4 text-lg-3 text-xl-4">
									...
									<strong class="text-3 ms-lg-3">
										<a href="<?= $email ?>" class="text-color-tertiary text-color-hover-primary text-decoration-underline"><span class="__cf_email__" data-cfemail="55363930343b263027233c363015313a38343c3b7b363a38"><?= $email ?></span></a>
									</strong>
								</span>
							</li>
						</ul>
				...
				<div class="row">
					<div class="col-6 col-xl-3 mb-5 mb-xl-0 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="200">
						<div class="d-flex align-items-center justify-content-center flex-column flex-xl-row text-center">
							...
							<h3 class="text-transform-none text-color-dark font-weight-bold mb-0 text-4 ps-1 ms-xl-2 mt-3 mt-xl-0">
								SEBI Registered</h3>
						</div>
					</div>
					<div class="col-6 col-xl-3 divider-left-border mb-5 mb-xl-0 appear-animation" data-appear-animation="fadeInLeftShorter">
						<div class="d-flex align-items-center justify-content-center flex-column flex-xl-row text-center">
							...
							<h3 class="text-transform-none text-color-dark font-weight-bold mb-0 text-4 px-2 px-sm-0 ps-1 ms-xl-2 mt-3 mt-xl-0">
					...
					<div class="col-6 col-xl-3 divider-left-border appear-animation" data-appear-animation="fadeInRightShorter">
						<div class="d-flex align-items-center justify-content-center flex-column flex-xl-row text-center">
							...
							<h3 class="text-transform-none text-color-dark font-weight-bold mb-0 text-4 px-3 px-sm-0 ps-1 ms-xl-2 mt-3 mt-xl-0">
								115000+ Happy Investors</h3>
						</div>
					</div>
					<div class="col-6 col-xl-3 divider-left-border appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="200">
						<div class="d-flex align-items-center justify-content-center flex-column flex-xl-row text-center">
							<svg fill="none" height="30" stroke="#212121" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" width="30" xmlns="http://www.w3.org/2000/svg">
								<path d="M22 11.07V12a10 10 0 1 1-5.93-9.14" />
								<polyline points="23 3 12 14 9 11" />
						...
						<div class="col-lg-5 mb-5 mb-lg-0">
							<div class="d-flex align-items-center mb-2">
								...
								<div class="overflow-hidden ms-3">
									<h2 class="text-color-primary font-weight-semibold line-height-3 text-4 mb-0 appear-animation" data-appear-animation="maskRight" data-appear-animation-delay="1000">WHO WE ARE
									</h2>
								</div>
							</div>
					...
					<div class="row align-items-end pb-3 mb-5 mb-lg-4">
						<div class="col-lg-7 col-xl-8 mb-4 mb-lg-0">
							<div class="d-flex align-items-center mb-2">
								<span class="custom-line appear-animation" data-appear-animation="customLineAnimation" appear-animation-duration="1s"></span>
								<div class="overflow-hidden ms-3">
									<h2 class="text-color-primary font-weight-semibold line-height-3 text-4 mb-0 appear-animation" data-appear-animation="maskRight" data-appear-animation-delay="1000">WHAT WE DO
									</h2>
								</div>
							</div>
					...
					<div class="row">
						<div class="col-lg-8">
							<div class="d-flex align-items-center mb-2">
								<span class="custom-line appear-animation" data-appear-animation="customLineAnimation" appear-animation-duration="1s"></span>
								<div class="overflow-hidden ms-3">
									<h2 class="text-color-primary font-weight-semibold line-height-3 text-4 mb-0 appear-animation" data-appear-animation="maskRight" data-appear-animation-delay="1000">WHY CHOOSE
										US</h2>
								</div>
							</div>
					...
					<div class="row align-items-end pb-3 mb-5 mb-lg-4">
						<div class="col-lg-7 col-xl-8 mb-4 mb-lg-0">
							<div class="d-flex align-items-center mb-2">
								<span class="custom-line appear-animation" data-appear-animation="customLineAnimation" appear-animation-duration="1s"></span>
								<div class="overflow-hidden ms-3">
									<h2 class="text-color-primary font-weight-semibold line-height-3 text-4 mb-0 appear-animation" data-appear-animation="maskRight" data-appear-animation-delay="1000">RECENT WORK
									</h2>
								</div>
							</div>
									...
									<div class="card custom-card-style-1 custom-card-style-1-variation">
										<div class="card-body text-center bg-color-light-scale-1 py-5">
											...
											<h4 class="text-color-secondary font-weight-bold line-height-1 text-5 mb-0">
												<a href="#" class="text-color-secondary text-color-hover-primary text-decoration-none">John
													Doe</a>
											</h4>
								...
								<div>
									<div class="card custom-card-style-1 custom-card-style-1-variation">
										<div class="card-body text-center bg-color-light-scale-1 py-5">
											...
											<h4 class="text-color-secondary font-weight-bold line-height-1 text-5 mb-0">
												<a href="#" class="text-color-secondary text-color-hover-primary text-decoration-none">Judie
													Doe</a>
											</h4>
											<p class="text-2 pb-1 mb-2">General Cleaner</p>
											<ul class="social-icons custom-social-icons social-icons-big">
								...
								<div>
									<div class="card custom-card-style-1 custom-card-style-1-variation">
										<div class="card-body text-center bg-color-light-scale-1 py-5">
											...
											<h4 class="text-color-secondary font-weight-bold line-height-1 text-5 mb-0">
												<a href="#" class="text-color-secondary text-color-hover-primary text-decoration-none">Monica
													Doe</a>
											</h4>
											<p class="text-2 pb-1 mb-2">General Cleaner</p>
											<ul class="social-icons custom-social-icons social-icons-big">
