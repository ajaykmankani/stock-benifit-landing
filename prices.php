...
<!-- Mirrored from www.okler.net/previews/porto/9.9.0/demo-cleaning-services-prices.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 21 Dec 2022 19:33:02 GMT -->
<head>
										...
										<div class="header-nav-main header-nav-main-text-capitalize header-nav-main-effect-2 header-nav-main-sub-effect-1">
											<nav class="collapse">
												<ul class="nav nav-pills" id="mainNav">
													...
													<li><a href="demo-cleaning-services-prices.html" class="nav-link active">Prices</a></li>
				...
				<section class="section border-0 pb-0 pb-lg-5 m-0">
					<div class="container mt-lg-4 pb-3">
						<div class="row mb-4 pb-2">
							<div class="col">
								<p class="custom-font-secondary text-4 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin bibendum ultricies nunc, eu interdum enim convallis pretium. </p>
						...
						<div class="row mb-5 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="600">
							<div class="col">
								<div class="owl-carousel nav-outside nav-arrows-1 custom-carousel-box-shadow-2 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="750" data-plugin-options="{'responsive': {'0': {'items': 1}, '479': {'items': 1}, '768': {'items': 2}, '979': {'items': 3}, '1199': {'items': 4}}, 'autoplay': false, 'autoplayTimeout': 5000, 'autoplayHoverPause': true, 'dots': false, 'nav': true, 'loop': false, 'margin': 20, 'stagePadding': '75'}">
									<div>
										<div class="card custom-card-style-1">
											<div class="card-body text-center py-5 px-4">
												<h3 class="text-color-primary font-weight-medium text-4 pb-1 mb-4">RESIDENTIAL MAINTENANCE</h3>
												...
												<a href="demo-cleaning-services-contact.html" class="btn btn-secondary btn-modern font-weight-bold text-3 px-5 btn-py-3">BOOK NOW</a>
											</div>
										</div>
									</div>
									<div>
										<div class="card custom-card-style-1">
											<div class="card-body text-center py-5 px-4">
												<h3 class="text-color-primary font-weight-medium text-4 pb-1 mb-4">OFFICE CLEANING</h3>
												<div class="price d-flex align-items-end justify-content-center font-weight-bold text-color-dark text-12 line-height-1 pb-1 mb-4">
													<span class="price-unit font-weight-normal custom-font-size-4 position-relative bottom-6">$</span>
													79
												</div>
									...
									<div>
										<div class="card custom-card-style-1">
											<div class="card-body text-center py-5 px-4">
												<h3 class="text-color-primary font-weight-medium text-4 pb-1 mb-4">FACILITY CLEANING</h3>
												<div class="price d-flex align-items-end justify-content-center font-weight-bold text-color-dark text-12 line-height-1 pb-1 mb-4">
													<span class="price-unit font-weight-normal custom-font-size-4 position-relative bottom-6">$</span>
													89
												</div>
									...
									<div>
										<div class="card custom-card-style-1">
											<div class="card-body text-center py-5 px-4">
												<h3 class="text-color-primary font-weight-medium text-4 pb-1 mb-4">BUILDING MAINTENANCE</h3>
												<div class="price d-flex align-items-end justify-content-center font-weight-bold text-color-dark text-12 line-height-1 pb-1 mb-4">
													<span class="price-unit font-weight-normal custom-font-size-4 position-relative bottom-6">$</span>
													99
												</div>
