...
<!-- Mirrored from www.okler.net/previews/porto/9.9.0/demo-cleaning-services-portfolio-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 21 Dec 2022 19:33:04 GMT -->
<head>
										...
										<div class="header-nav-main header-nav-main-text-capitalize header-nav-main-effect-2 header-nav-main-sub-effect-1">
											<nav class="collapse">
												<ul class="nav nav-pills" id="mainNav">
													...
													<li><a href="demo-cleaning-services-portfolio.html" class="nav-link active">Portfolio</a></li>
					...
					<div class="container my-3">
						<div class="row">
							<div class="col-md-12 align-self-center p-static order-2 text-center">
								<h1 class="font-weight-bold text-10">Porto Building</h1>
							</div>
